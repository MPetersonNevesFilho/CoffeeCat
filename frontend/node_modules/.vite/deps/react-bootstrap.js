...
import {
  ...
  require_warning,
  useCol
} from "./chunk-GLHYSJAP.js";
import {
  require_prop_types
} from "./chunk-PUHH75AR.js";
import {
  createWithBsPrefix
} from "./chunk-H5UHNGZM.js";
import {
  Container_default
...
var Pagination = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime48.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames31.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames32.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var Row = React49.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames35.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React50.forwardRef(({
  ...
  return (0, import_jsx_runtime54.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames36.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React51.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  children: [(0, import_jsx_runtime55.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime55.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
...
var TabPanel = React53.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime63.jsx)(import_jsx_runtime62.Fragment, {});
};
...
var Toast = React63.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime70.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames41.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
...
var ToastContainer = React64.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames42.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var ToggleButton = React65.forwardRef(({
  ...
  return (0, import_jsx_runtime74.jsxs)(import_jsx_runtime73.Fragment, {
    children: [(0, import_jsx_runtime72.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime72.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames43.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
